    ...
    def __init__(self, server_ip,username,password,dataDB):
        ...
        if dataDB == "aurin-property":
            ...
            self.allviews={
                "houseBuilding": {
                    "reduce": "_sum",
                    "map": "function (doc) {\n  emit([doc.year,doc.sa3code],{newHouseNum:doc.new_houses_num,newOtherResidentialNum:doc.new_other_residential_num});\n}"
                }
            }
            ...
            self.allviews={
                "clientCount": {
                    "reduce": "_sum",
                    "map": "function (doc) {\n  emit([doc.financial_year,doc.sa3code], doc.client_count);\n}"
                }
            }
